...
<link href="../../css/UpdateAddmin/table.css" rel="stylesheet" type="text/css" />
<!-- InstanceEndEditable -->
...
<div class="content-wrapper">
  ...
  <div class="panel panel-default box">
    <div class="panel-heading"> <i class="fa fa-plus-square"></i> Thêm Một Địa Điểm Du Lịch </div>
    <div class="panel-body"> 
      <!--box-->
      <div class="box-content">
        <form>
          <div class="form-group">
            <label >Mã Địa Điểm Du Lịch</label>
            <input  type="text" class="form-control" id="maDiaDiemDL" placeholder="Mã địa điểm du lịch">
          </div>
          <div class="form-group">
            <label >Tên Địa Điểm Du Lịch</label>
            <input type="text" class="form-control" id="tenDiaDiemDL" placeholder="Tên địa điểm du lịch">
          </div>
          <p>
            <button type="button" class="btn btn-default btn-sm btn-block"><i class="fa fa-plus-square-o"></i> Thêm </button>
          </p>
        </form>
      </div>
    </div>
