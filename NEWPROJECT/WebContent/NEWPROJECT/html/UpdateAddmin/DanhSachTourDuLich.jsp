...
<!-- InstanceBegin template="/Templates/Addmin.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
<aside class="main-sidebar">
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview"> <a href="NewThemMotDiaDiemDL.jsp"> <i class="fa fa-cubes"></i> <span>Địa Điểm Du Lịch</span> </a> </li>
      ...
      <li class="treeview"> <a href="NewTatCaCacUser.jsp"> <i class="fa fa-users"></i> <span>Người Dùng</span> </a> </li>
...
<div class="content-wrapper">
  ...
  <div class="panel panel-default">
    <div class="panel-heading"><i class="fa fa-list-alt"></i>Danh Sách Tour Du Lịch</div>
