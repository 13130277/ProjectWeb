...
<!-- InstanceEndEditable -->
<link href="/NEWPROJECT/NEWPROJECT/Bootstrap/bootstrap/css/bootstrap.min.css"
	rel="stylesheet" type="text/css" />
<link href="/NEWPROJECT/NEWPROJECT/Bootstrap/dist/css/font-awesome.min.css" rel="stylesheet" />
<link href="/NEWPROJECT/NEWPROJECT/Bootstrap/glyphicons.css" rel="stylesheet"
	type="text/css" />
<script src="/NEWPROJECT/NEWPROJECT/Bootstrap/dist/js/jQuery-2.1.4.min.js"></script>
<script src="/NEWPROJECT/NEWPROJECT/Bootstrap/bootstrap/js/bootstrap.min.js"
...
<body>
	...
	<div id="container">
		<div id="header">
			...
			<div id="banner">
				<div id="logo">
					<img src="/NEWPROJECT/NEWPROJECT/img/logo/flower banner 1 - Copy.jpg" />
				</div>
				<div class="row">
					<div class="col-lg-6">
			...
			<div class="row">
				<div class="col-md-12">
					<ul class="nav nav-tabs">
						...
						<li ><a href="#"><i
								class="fa fa-book"></i>Cẩm Nan Du Lịch</a></li>
						<li class="dropdown"><a class="dropdown-toggle"
							data-toggle="dropdown" href="#">Du Lịch Trong Nước<span
								class="caret"></span></a> </a> 
							<ul class="dropdown-menu">
							 <li><a href="<%= response.encodeURL("DuLichTrongNuoc")%>">  Tất cả các Tour</a></li> 
								<%
 								for (Tour_Type los : listTypeTour) {
 									String param = los.getNameType();
 								%>
								<li><a href="<%=response.encodeURL("DuLichTrongNuoc?newUrl="+param)%>" > <%=los.getNameType() %>
								</a></li>
		...
		<div id="slider">
			...
			<div id="wowslider-container1">
				<div class="ws_images">
					<ul>
						<li><img src="/NEWPROJECT/NEWPROJECT/data1/images/01.jpg" alt="" title=""
							id="wows1_0" /></li>
						<li><img src="/NEWPROJECT/NEWPROJECT/data1/images/02.jpg" alt="" title=""
							id="wows1_1" /></li>
						<li><a href="http://wowslider.net"><img
								src="/NEWPROJECT/NEWPROJECT/data1/images/03.jpg" alt="wowslider.net" title=""
								id="wows1_2" /></a></li>
						<li><img src="/NEWPROJECT/NEWPROJECT/data1/images/04.jpg" alt="" title=""
							id="wows1_3" /></li>
					</ul>
				</div>
				<div class="ws_bullets">
					<div>
						<a href="#" title=""><span><img
								src="/NEWPROJECT/NEWPROJECT/data1/images/01.jpg" alt="" />1</span></a> <a href="#" title=""><span><img
								src="/NEWPROJECT/NEWPROJECT/data1/tooltips/02.jpg" alt="" />2</span></a> <a href="#" title=""><span><img
								src="/NEWPROJECT/NEWPROJECT/data1/tooltips/03.jpg" alt="" />3</span></a> <a href="#" title=""><span><img
			...
			<script type="text/javascript" src="/NEWPROJECT/NEWPROJECT/engine1/wowslider.js"></script>
			<script type="text/javascript" src="/NEWPROJECT/NEWPROJECT/engine1/script.js"></script>
