...
<div class="content-wrapper">
  ...
  <div class="panel panel-default">
    <div class="panel-heading"> <i class="fa fa-tree"></i> Địa Điểm Du Lịch </div>
        ...
        <table class="table table-bordered table-striped" >
          ...
          <tbody>
            <tr>
              ...
              <td>DL2001</td>
              <td>DLTour01</td>
              <td>Thung Lũng Tình Yêu</td>
              <td>22/12/2015</td>
              <td><img /></td>
              <td>... Phan Thị Ngọc Tâm </td>
              <td><button type="button" class="btn btn-info"><span class="glyphicon glyphicon-pencil"></span></i></button>
