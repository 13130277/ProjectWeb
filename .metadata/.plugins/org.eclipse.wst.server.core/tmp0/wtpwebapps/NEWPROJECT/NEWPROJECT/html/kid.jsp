...
<div id="container">
  <div id="header">  <div id="login_loout">
    ...
    <div id="banner">
      <div id="logo"><a href="../home.jsp"><img src="../img/logo/flower%20banner%201%20-%20Copy.jpg"  /></a></div>
      <div class="row">
        <div class="col-lg-6">
 ...
 <!--end header--> 
  ...
  <!-- InstanceBeginEditable name="change2" -->
  <div id="menu">
        <div class="row">
      <div class="col-md-12">
        <ul class="nav nav-tabs">
          <li ><a href="home.jsp"><i class="fa fa-home"></i>Trang chủ</a></li>
          <li><a href="Camnangdulich.jsp"><i class="fa fa-book"></i>Cẩm Nan Du Lịch</a></li>
          <li class="active"><a href="kid.jsp"><i class="fa fa-car"></i>Du Lịch Trong Nước</a></li>
          <li><a href="kid - Copy.jsp"><i class="fa fa-plane"></i>Du Lịch Nước Ngoài</a></li>
          <li><a href="../dangky.jsp"><i class="fa fa-users"></i>Khách Hàng</a><ul></ul></li>
  ...
  <div class="row"> 
    ...
    <div class="col-xs-3 col-md-8">
      <div class="thumbnail"  id="info1"> <img src="../img/tourdalat/9-Du-lich-da-lat-thang-7-mytour-3.jpg" 
      title="Du Lịch Đà Lạt" />
        <div class="caption">
          <h3>Du Lịch Đà Lạt</h3>
          <p>Đà lạt ví như Pari thu nhỏ, với những biệt thự xinh xắn mang kiến trúc Châu Âu, những lối đi đầy hoa và cỏ dại, với rừng thông bạt ngàn bao bọc</p>
