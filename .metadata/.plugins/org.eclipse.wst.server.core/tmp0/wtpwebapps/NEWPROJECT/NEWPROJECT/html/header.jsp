...
<%@page import="Controller.LoadData"%>
...
<!-- InstanceEndEditable -->
<link href="../Bootstrap/bootstrap/css/bootstrap.min.css"
...
<body>
	...
	<div id="container">
		<div id="header">
			...
			<div id="banner">
				<div id="logo">
					<img src="../img/logo/flower banner 1 - Copy.jpg" />
				</div>
				<div class="row">
					<div class="col-lg-6">
			...
			<div class="row">
				<div class="col-md-12">
					<ul class="nav nav-tabs">
						<li><a href="home.jsp"><i class="fa fa-home"></i>Trang
								chủ</a></li>
						<li class="active"><a href="Camnangdulich.jsp"><i
 ...
 %>
						...
						<li><a href="file:///G|/NEWPROJECT/dangNhap.jsp"><i
		...
		<div id="slider">
			...
			<div id="wowslider-container1">
				<div class="ws_images">
					<ul>
						<li><img src="../data1/images/01.jpg" alt="" title=""
							id="wows1_0" /></li>
						<li><img src="../data1/images/02.jpg" alt="" title=""
							id="wows1_1" /></li>
						<li><a href="http://wowslider.net"><img
								src="../data1/images/03.jpg" alt="wowslider.net" title=""
								id="wows1_2" /></a></li>
						<li><img src="../data1/images/04.jpg" alt="" title=""
							id="wows1_3" /></li>
					</ul>
				</div>
				<div class="ws_bullets">
					<div>
						<a href="#" title=""><span><img
								src="../data1/images/01.jpg" alt="" />1</span></a> <a href="#" title=""><span><img
								src="../data1/tooltips/02.jpg" alt="" />2</span></a> <a href="#" title=""><span><img
								src="../data1/tooltips/03.jpg" alt="" />3</span></a> <a href="#" title=""><span><img
								src="../data1/tooltips/04.jpg" alt="" />4</span></a>
					</div>
				</div>
