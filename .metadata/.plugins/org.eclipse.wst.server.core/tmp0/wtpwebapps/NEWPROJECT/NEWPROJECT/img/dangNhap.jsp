...
<body class="login">
	...
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<form class="form-vertical login-form" action="../DangNhap" method="post">
			<h3 class="form-title">Đăng nhập vào tài khoản của bạn</h3>
			<div class="alert alert-error hide">
				<button class="close" data-dismiss="alert"></button>
				<span>Điền tên và mật khẩu đăng nhập.</span>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i>
						<input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="Tên Đăng Nhập" name="uname"/>
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-lock"></i>
						<input class="m-wrap placeholder-no-fix" type="password" autocomplete="off" placeholder="Mật Khẩu" name="pass"/>
					</div>
				</div>
			</div>
			...
			<div class="forget-password">
				<h4>Quên Mật Khẩu</h4>
				<p>
					 click <a href="javascript:;"  id="forget-password">vào đây</a>
					để lấy lại mật khẩu
				</p>
			</div>
		...
		<form class="form-vertical forget-form" action="index.jsp" method="post">
			...
			<p>Điền email của bạn để lấy lại mật khẩu</p>
			<div class="control-group">
				<div class="controls">
					<div class="input-icon left">
			...
			<div class="form-actions">
				...
				<i class="m-icon-swapleft"></i> trở lại
				</button>
				<button type="submit" class="btn blue pull-right">
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="text" placeholder="Tỉnh/Thành Phố" name="city"/>
					</div>
				</div>
			</div>
