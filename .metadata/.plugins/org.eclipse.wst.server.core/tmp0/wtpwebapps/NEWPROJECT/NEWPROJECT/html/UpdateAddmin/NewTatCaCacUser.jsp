...
<div class="content-wrapper">
  <div class="container">
    <div class="col-sm-6 col-md-2">
      <div class="thumbnail tile tile-orange"> <a href="#" > <span class="glyphicon glyphicon-user"  ></span><span class="badge">237</span>
        <p>Users</p>
        </a> </div>
    </div>
    <div class="col-sm-6 col-md-2">
      <div class="thumbnail tile tile-red"> <a href="#" > <span class="glyphicon glyphicon-comment"  ></span><span class="badge">237</span>
        <p>Bình Luận mới</p>
        </a> </div>
    </div>
    <div class="col-sm-6 col-md-2">
      <div class="thumbnail tile tile-blue"> <a href="#" > <span class="glyphicon glyphicon-shopping-cart"  ></span><span class="badge">13</span>
        <p>Tour mới đặt</p>
        </a> </div>
    </div>
    <div class="col-sm-6 col-md-2">
      <div class="thumbnail tile tile-green"> <a href="#" > <span class="glyphicon glyphicon-envelope"></span><span class="badge">88</span>
        <p>Tin nhắn</p>
        </a> </div>
    </div>
    <div class="col-sm-6 col-md-2">
  ...
  <div class="panel panel-default">
    <div class="panel-heading"> <span  class="glyphicon glyphicon-user"></span> Danh sách user admin
        ...
        <table class="table table-bordered table-striped" >
          ...
          <tbody>
            <tr>
              ...
              <td>...</td>
              <td><button type="button" class="btn btn-success"><i class="fa fa-user-times"></i></button>
                <button type="button" class="btn btn-info"><span class="glyphicon glyphicon-pencil"></span></i></button>
  ...
  <!--end panel_default-->
   <!--start panel_default-->
  <div class="panel panel-default">
    <div class="panel-heading"> <span  class="glyphicon glyphicon-user"></span> Danh sách user nhân viên
      <ul class="nav navbar-nav navbar-right">
        <span style="margin-right:10px;" class="glyphicon glyphicon-remove"></span>
      </ul>
    </div>
        ...
        <table class="table table-bordered table-striped" >
          ...
          <tbody>
            <tr>
              ...
              <td>thehalftheart@mail.com</td>
              <td>...</td>
              <td><button type="button" class="btn btn-success"><i class="fa fa-user-plus"></i></button>
                <button type="button" class="btn btn-info"><span class="glyphicon glyphicon-pencil"></span></i></button>
                <button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></button></td>
            </tr>
            <tr>
  ...
  <!--start panel_default-->
  <div class="panel panel-default">
    <div class="panel-heading"> <span  class="glyphicon glyphicon-user"></span> Danh sách user khách hàng
      <ul class="nav navbar-nav navbar-right">
        <span style="margin-right:10px;" class="glyphicon glyphicon-remove"></span>
      </ul>
    </div>
